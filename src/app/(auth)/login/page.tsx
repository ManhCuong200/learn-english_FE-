  ...
  const onSubmit = async (data: LoginFormData): Promise<void> => {
    try {
      ...
      if (!payload.twoFactorCode) {
        delete payload.twoFactorCode;
      }
      const result = await loginMutation.mutateAsync(payload) as { isTwoFactorRequired?: boolean };
      ...
      <div className="w-full max-w-xl">
        ...
        <div className="mb-6">
          <a
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border bg-background px-4 py-3.5 text-base font-medium transition hover:bg-muted"
          >
