import { BookOpen, Check, ChevronRight, Flame, Headphones, Sparkles } from 'lucide-react';
  ...
  return (
    <>
      <div className="border-b border-border/80 bg-background/80 px-6 py-5 backdrop-blur sm:px-10">
        ...
        <h1 className="mt-1 font-display text-2xl sm:text-3xl">Good morning, {firstName}.</h1>
      </div>
